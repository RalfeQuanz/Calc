...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickNumeros(View view) {
       ...
       // valor3 = Integer.(resultado.getText().toString());
    ...
    public void onClickOperacao(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.bSinal:
                ...
                valor1 = -1*valor1;
                valor2= (int) valor1;
               // valor_sinal = Integer.valueOf(valor1);
                resultado.setText(String.valueOf(valor2));
                //resultado.setText("");
            ...
            case R.id.bVirgula:
                ...
                if (flagVirgula!=1) {
                    if (resultado.getText().equals(""))
                        resultado.setText("0" + resultado.getText() + numero);
                    else
                        resultado.setText(resultado.getText() + numero);
                }
                break;
